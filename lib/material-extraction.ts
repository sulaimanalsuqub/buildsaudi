        ...
        messages: [
          {
            role: "system",
            content:
              "You extract construction procurement line items from Arabic or English customer requests, BOQ files, quantity schedules, CSV text, and Excel sheet text. Return JSON only. Extract product/material rows with quantity, unit, category, and specs. Do not invent brands, quantities, or specs. Use Arabic category names when possible, such as الأدوات الصحية، الكهرباء والإنارة، السباكة وأنظمة الأنابيب، التكييف والتهوية، الأرضيات، الجداريات، الدهانات الداخلية والخارجية، اللواصق والمواد المساعدة. Confidence must be 0 to 100. If a row is unclear, keep it with low confidence.",
          },
          {
            role: "user",
            content: [
