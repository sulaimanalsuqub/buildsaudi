...
const CATEGORY_TO_ITEM_GROUP: Record<string, string> = {
  // فئات الموردين الحالية (lib/vendor-options.ts productCategories)
  sanitaryware_bath_fittings: "Sanitaryware and Bath Fittings",
  electrical_lighting: "Electrical and Lighting",
  plumbing_piping_systems: "Plumbing and Piping Systems",
  hvac: "HVAC",
  tiles_flooring: "Tiles and Flooring",
  wall_finishes_coverings: "Wall Finishes and Coverings",
  paints_coatings: "Paints and Coatings",
  adhesives_grouts_sealants: "Adhesives Grouts and Sealants",
  "الأدوات الصحية": "Sanitaryware and Bath Fittings",
  "الكهرباء والإنارة": "Electrical and Lighting",
  "السباكة وأنظمة الأنابيب": "Plumbing and Piping Systems",
  "التكييف والتهوية": "HVAC",
  "الأرضيات": "Tiles and Flooring",
  "الجداريات": "Wall Finishes and Coverings",
  "الدهانات الداخلية والخارجية": "Paints and Coatings",
  "اللواصق والمواد المساعدة": "Adhesives Grouts and Sealants",
  ...
  "دهانات وديكور": "Paints and Coatings",
  "كهرباء وإنارة": "Electrical and Lighting",
  "تكييف وتبريد": "HVAC",
  "أنظمة الأنابيب": "Plumbing and Piping Systems",
  "مضخات وخزانات": "Pumps and Tanks",
  "أرضيات وسيراميك": "Tiles and Flooring",
  عوازل: "Insulation",
  "مواد لاصقة": "Adhesives Grouts and Sealants",
  "مواد بناء": "Building Materials",
  "حديد": "Building Materials",
  "أسمنت": "Building Materials",
  "عزل": "Insulation",
  "عزل حراري": "Insulation",
  "سباكة": "Plumbing and Piping Systems",
  "كهرباء": "Electrical and Lighting",
  "إضاءة": "Electrical and Lighting",
  "أرضيات": "Tiles and Flooring",
  "سيراميك": "Tiles and Flooring",
  "دهانات": "Paints and Coatings",
  "تشطيبات": "Paints and Coatings",
  "تكييف": "HVAC",
  "أنابيب": "Plumbing and Piping Systems",
  "مضخات": "Pumps and Tanks",
  "خزانات": "Pumps and Tanks",
  "أدوات سلامة": "Safety Tools",
  "أدوات صحية": "Sanitaryware and Bath Fittings",
  "لاصقات": "Adhesives Grouts and Sealants",

  // قيم قديمة لموردين مسجّلين قبل تحديث الفئات — تبقى للتوافق الرجعي فقط
  building_materials: "Building Materials",
  insulation: "Insulation",
  safety_tools: "Safety Tools",
  paint_decor: "Paints and Coatings",
  plumbing: "Plumbing and Piping Systems",
  sanitary_ware: "Sanitaryware and Bath Fittings",
  piping_systems: "Plumbing and Piping Systems",
  pumps_tanks: "Pumps and Tanks",
  flooring_ceramics: "Tiles and Flooring",
  adhesives: "Adhesives Grouts and Sealants",
  electrical: "Electrical and Lighting",
  flooring: "Tiles and Flooring",
  paint: "Paints and Coatings",
  piping: "Plumbing and Piping Systems",
  pumps: "Pumps and Tanks",
  safety: "Safety Tools",
  sanitary: "Sanitaryware and Bath Fittings",
};
