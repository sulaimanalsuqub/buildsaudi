...
export const metadata = pageMetadata({
  ...
  title: "سياسة ملفات تعريف الارتباط | بيلد",
  description: "تعرّف على استخدام بيلد لملفات تعريف الارتباط لتشغيل الموقع وحمايته وفهم استخدامه، والفرق بين أنواعها وكيفية التحكم في إعداداتها.",
});
