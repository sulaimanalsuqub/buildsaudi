...
export default function ArabicPrivacyPolicyPage() {
  return (
    <LegalPageContent title="سياسة الخصوصية" badge="السياسات" isRtl>
      ...
      <p className="type-body text-brand-dark/80">
        لا نبيع بياناتك لأطراف ثالثة. يجوز مشاركة البيانات الضرورية فقط مع مزودي الخدمات الذين يساعدوننا في تشغيل المنصة، وذلك بموجب التزامات سرية ومعالجة محدودة.
      </p>
      <p className="type-body text-brand-dark/80">
