...
const FormLabel = React.forwardRef<HTMLLabelElement, React.LabelHTMLAttributes<HTMLLabelElement>>(({ className, ...props }, ref) => {
  ...
  return <label ref={ref} className={cn("text-sm font-semibold", error ? "text-red-600" : "text-brand-dark", className)} htmlFor={formItemId} {...props} />;
});
...
const FormDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(({ className, ...props }, ref) => {
  ...
  return <p ref={ref} id={formDescriptionId} className={cn("text-sm text-brand-dark/60", className)} {...props} />;
});
