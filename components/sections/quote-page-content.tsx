  ...
  return (
    <div className="rounded-2xl border border-brand-dark/10 bg-white p-8 shadow-sm md:p-10">
      ...
      <p className="mt-3 max-w-xl text-sm leading-7 text-brand-dark/65">
        {isRtl
          ? "اكتب تفاصيل المشروع والمواد المطلوبة (أو أرفق جدول الكميات) على البريد التالي. فريق بيلد يتابع الطلب ويرد عليك."
          : "Send your project details and required materials (or attach a BOQ) to the address below. The Build team will follow up with you."}
      </p>
